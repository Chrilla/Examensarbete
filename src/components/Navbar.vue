    ...
    <b-collapse id="nav-collapse" is-nav>
      ...
      <b-navbar-nav class="ml-auto">
        <div class="input-wrapper">
          <b-form-input size="sm" id="searchfield" type="search" placeholder="Enter your search here..."></b-form-input>
          <b-button for="searchfield" class="fas fa-search input-icon" type="submit"></b-button>
        </div>
...
a.router-link-exact-active {
  ...
  border-left: 3px solid var(--red-theme);
